...
유럽위원회의 기술주권·안보·민주주의 담당 집행부위원장인 헨나 비르쿠넨은 이번 지정으로 ChatGPT와 Reddit, Roblox가 시민과 사회에 미치는 영향이 큰 만큼 더 높은 수준의 감독과 책임을 지게 된다고 밝혔습니다. 붙는 의무는 가볍지 않습니다. 매년 자기 서비스가 만드는 구조적 위험을 평가하고 완화해야 하고, 독립 감사를 받아야 하고, 알고리즘을 어떻게 운용하는지 설명해야 하고, 미성년자 보호 조치를 갖춰야 하고, 광고 저장소를 열어야 하고, 연구자에게 데이터 접근을 허용해야 합니다. 기한은 통지로부터 4개월입니다. 어기면 전 세계 연매출의 최대 6%까지 과징금이 나올 수 있고요.

여기서 눈여겨볼 것은 이 의무들이 어디서 온 것인지입니다. 전부 구글 검색과 페이스북 같은 서비스를 겨냥해 설계된 조항들입니다. 그것이 생성형 AI 제품에 그대로 얹혔습니다. 그래서 디지털서비스법상 검색엔진으로 이 규모의 지정을 받은 이름은 셋이 됐습니다. 구글 검색, 마이크로소프트 빙, 그리고 ChatGPT입니다.
...
물론 규제 대상이 자기 수치를 신고하는 구조는 이상한 일이 아닙니다. 이용자 수를 바깥에서 셀 방법이 없으니 신고에 의존하는 것이 오히려 자연스럽죠. 다만 그 신고에 담긴 정의를 정하는 쪽도 신고자입니다. 무엇을 검색 이용 한 번으로 셀 것인지, 그 세부 기준은 공개되지 않았습니다. 문턱을 넘긴 숫자는 확정됐는데 그 숫자가 무엇을 센 것인지는 확정되지 않은 상태입니다.
