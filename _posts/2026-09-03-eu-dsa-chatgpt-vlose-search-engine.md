...
excerpt: "유럽연합 집행위원회가 ChatGPT를 디지털서비스법상 초대형 온라인 검색엔진으로 지정했습니다. AI 어시스턴트가 검색엔진으로 분류된 첫 사례인데요. 그런데 지정의 근거가 된 이용자 수는 OpenAI가 스스로 신고하면서 다른 용도로 쓰지 말라는 단서까지 붙여 둔 숫자였습니다."
coverImage: ""
category: "AI"
---
...
![헨나 비르쿠넨 EU 집행위원회 집행부위원장. 지정 대상 세 서비스가 더 높은 수준의 감독과 책임을 지게 된다고 밝혔습니다.](/images/covers/eu-dsa-chatgpt-vlose-search-engine-virkkunen.jpg)
