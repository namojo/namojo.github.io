...
지난 1년의 경과를 보면 이 질문의 그늘은 꽤 선명해졌습니다. 2025년 상반기에 발표된 국가대표 후보 기업들 중 일부는 예산 집행 단계에서 기술 로드맵을 대폭 수정해야 했습니다. 1년 전에 "최첨단"이라 불리던 모델 스케일이, 지금은 오픈소스 모델들로도 따라잡히는 크기가 되었기 때문이지요. 2025년 말부터 2026년 초까지 중국과 미국에서 쏟아진 모델들, 그리고 앤트로픽Anthropic의 클로드 4.6과 1백만 토큰 컨텍스트 같은 변화 앞에서 **"2024년 시점에서 설계된 로드맵으로 2026년의 경쟁에 나서는 구조적 어려움"**이 드러났습니다.
