...
오픈AI도 이 점을 인정한 듯합니다. o1은 기존 GPT를 대체하는 것이 아니라, **병렬로 존재하는 또 다른 선택지**로 자리매김했습니다. 빠른 직관과 깊은 추론, 두 가지 지능을 상황에 따라 골라 쓰라는 뜻입니다. 인간의 사고도 비슷하지 않습니까. 심리학자 대니얼 카너먼이 '생각에 관한 생각(Thinking), Fast and Slow'에서 말했던 '빠른 사고(시스템 1)'와 '느린 사고(시스템 2)' — 이 구분이 AI에도 적용되기 시작한 것입니다.
